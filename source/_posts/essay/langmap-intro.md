...
保護語言多樣性最好的方式就是多學幾門新語言。根據教科文組織的統計，包括口語和手語在內，世界上共有 8324種語言，其中還在使用的大概有 7000種，並且**每兩周就有一種語言消失**。消失的不僅是語言本身，還有再此之上的文化，那些與古老的過去連結的聲音和符號，那些流傳下來的鮮活的表達，彷彿在世界上不曾存在過。
...
此外，網站還特意開發了收藏集功能，看見好的詞句可以收藏起來，以便日後回顧。收藏夾中的詞句還可以全部匯出成 JSON/CSV 格式檔案以便程式處理。

![LangMap收藏集](langmap-intro/langmap-collection.png)

![LangMap收藏匯出](langmap-intro/langmap-export.png)
